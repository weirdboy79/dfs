...
In order to support loading of multiple wallets in dfs-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dfs.cpp.
...
Changes to dfs.cpp
----------------------
dfs.cpp is the entry point into dfs-qt, and as such, will require some minor modifications to provide hooks for
