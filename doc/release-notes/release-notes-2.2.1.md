Dfs version 2.2.1 is now available from:

  <https://github.com/defensebox/dfs/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/defensebox/dfs/issues>

Compatibility
==============

Dfs is extensively tested on multiple operating systems using
...
Dfs should also work on most other Unix-like systems but is not
...
of Bitcoin that DFS was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/dfscoin-translations/).
