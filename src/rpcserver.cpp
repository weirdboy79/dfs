...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Dfs features */
        {"dfs", "masternode", &masternode, true, true, false},
        {"dfs", "listmasternodes", &listmasternodes, true, true, false},
        {"dfs", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dfs", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dfs", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dfs", "masternodedebug", &masternodedebug, true, true, false},
        {"dfs", "startmasternode", &startmasternode, true, true, false},
        {"dfs", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dfs", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dfs", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dfs", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dfs", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dfs", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dfs", "mnbudget", &mnbudget, true, true, false},
        {"dfs", "preparebudget", &preparebudget, true, true, false},
        {"dfs", "submitbudget", &submitbudget, true, true, false},
        {"dfs", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dfs", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dfs", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dfs", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dfs", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dfs", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dfs", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dfs", "checkbudgets", &checkbudgets, true, true, false},
        {"dfs", "mnsync", &mnsync, true, true, false},
        {"dfs", "spork", &spork, true, true, false},
        {"dfs", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"dfs", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dfsd, or the -server option to dfs-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> dfs-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:28991/\n";
}
