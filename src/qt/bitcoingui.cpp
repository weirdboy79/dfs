...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DFS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dfs: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dfs"), this);
    aboutAction->setStatusTip(tr("Show information about Dfs"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DFS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DFS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DFS addresses"));
    ...
    openAction->setStatusTip(tr("Open a DFS: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dfs help message to get a list with possible DFS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Dfs client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DFS network", "", count));
}
...
{
    QString strTitle = tr("Dfs"); // default title
