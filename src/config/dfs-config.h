/* src/config/dfs-config.h.  Generated from dfs-config.h.in by configure.  */
/* src/config/dfs-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "defensebox.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Dfs Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Dfs Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dfs"
