...
#if defined(NDEBUG)
#error "DFS cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight < 60) {
      nSubsidy = 5000 * COIN;
    } else if (nHeight >= 60 && nHeight <= 1440) {
      nSubsidy = 1 * COIN;
    } else if (nHeight > 1440 && nHeight <= 5000) {
      nSubsidy = 0.1 * COIN;
    } else if (nHeight > 5000 && nHeight <= 15000) {
      nSubsidy = 9 * COIN;
      ...
      nSubsidy = 6 * COIN;
    } else if (nHeight > 45000 && nHeight <= 55000) {
      nSubsidy = 5 * COIN;
    } else if (nHeight > 55000 && nHeight <= 65000) {
      nSubsidy = 4 * COIN;
    } else if (nHeight > 65000 && nHeight <= 75000) {
      nSubsidy = 3 * COIN;
