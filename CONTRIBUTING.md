...
The Dfs project operates an open contributor model where anyone is
...
The following applies to code changes to the Dfs project, and is not to be
confused with overall DFS Network Protocol consensus changes.

Whether a pull request is merged into Dfs rests with the project merge
...
Patches that change DFS consensus rules are considerably more involved than
...
Where a patch set proposes to change the DFS consensus, it must have been
...
The project leader is the release manager for each Dfs release.
