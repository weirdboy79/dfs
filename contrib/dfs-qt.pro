...
RESOURCES += src/qt/dfs.qrc src/qt/dfs_locale.qrc

TRANSLATIONS += src/qt/locale/dfs_bg.ts \
                src/qt/locale/dfs_de.ts \
                src/qt/locale/dfs_en.ts \
                src/qt/locale/dfs_es.ts \
                src/qt/locale/dfs_fi.ts \
                src/qt/locale/dfs_fr.ts \
                src/qt/locale/dfs_it.ts \
                src/qt/locale/dfs_ja.ts \
                src/qt/locale/dfs_pl.ts \
                src/qt/locale/dfs_pt.ts \
                src/qt/locale/dfs_ru.ts \
                src/qt/locale/dfs_sk.ts \
                src/qt/locale/dfs_sv.ts \
                src/qt/locale/dfs_vi.ts \
                src/qt/locale/dfs_zh_CN.ts \
                src/qt/locale/dfs_zh_TW.ts
